...
/// <summary>
/// This class provides an empty implementation of <see cref="IJava8ParserVisitor{Result}"/>,
...
public partial class Java8ParserBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IJava8ParserVisitor<Result> {
	/// <summary>
